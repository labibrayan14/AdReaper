/*******************************************************************************
    ...
    AdReaper - a browser extension to block requests.
...
(function() {
    ...
    Gaq.prototype.push = function(a) {
        ...
        // https://github.com/uBlockOrigin/AdReaper-issues/issues/1807
        if (
            typeof a[0] === 'string' &&
            /(^|\.)_link$/.test(a[0]) &&
            typeof a[1] === 'string'
        ...
        // https://github.com/Labibrayan14/AdReaper/issues/2162
