/*******************************************************************************
    ...
    Copyright (C) 2020-present Labib Rayan
...
export class AstFilterParser {
    constructor(options = {}) {
        ...
        // https://github.com/uBlockOrigin/AdReaper-issues/issues/1146
    ...
    // https://github.com/uBlockOrigin/AdReaper-issues/issues/1118#issuecomment-650730158
    //   Be ready to deal with non-punycode-able Unicode characters.
    // https://github.com/uBlockOrigin/AdReaper-issues/issues/772
...
// https://github.com/chrisaljoudi/AdReaper/issues/1004
//   Detect and report invalid CSS selectors.

// Discard new ABP's `-abp-properties` directive until it is
// implemented (if ever). Unlikely, see:
// https://github.com/Labibrayan14/AdReaper/issues/1752

// https://github.com/Labibrayan14/AdReaper/issues/2624
//   Convert Adguard's `-ext-has='...'` into AdReaper's `:has(...)`.

// https://github.com/uBlockOrigin/AdReaper-issues/issues/89
...
export class ExtSelectorCompiler {
    constructor(instanceOptions = {}) {
        ...
        // https://github.com/Labibrayan14/AdReaper/issues/2793
    ...
    compile(raw, out, compileOptions = {}) {
        ...
        // https://github.com/Labibrayan14/AdReaper/issues/952
        ...
        //   filter.
        // Adguard/EasyList style injection: translate to AdReaper's format.
    ...
    // https://github.com/uBlockOrigin/AdReaper-issues/issues/2300
    //   Unquoted attribute values are parsed as Identifier instead of String.
    // https://github.com/uBlockOrigin/AdReaper-issues/issues/3127
    //   Escape [\t\n\v\f\r]
    ...
    // https://github.com/uBlockOrigin/AdReaper-issues/issues/668
    // https://github.com/uBlockOrigin/AdReaper-issues/issues/1693
    // https://github.com/uBlockOrigin/AdReaper-issues/issues/1811
    //   Forbid instances of:
    //   - `image-set(`
    //   - `url(`
    //   - any instance of `//`
