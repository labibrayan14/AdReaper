...
// https://github.com/Labibrayan14/AdReaper/issues/672
...
// https://github.com/uBlockOrigin/AdReaper-issues/discussions/2076
...
const stopAll = reason => {
    ...
    console.info(`AdReaper: Generic cosmetic filtering stopped because ${reason}`);
};
