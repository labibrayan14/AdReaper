/*******************************************************************************
    ...
    Copyright (C) 2026-present Labib Rayan
...
import { minimizeRules, minimizeRuleset, validateRules } from '../AdReaper-parser.js';
import { fetchList } from './fetch-list.js';
import { makeCosmeticScripts } from './make-cosmetic-filters.js';
import { parseNetworkFilter } from '../AdReaper-parser.js';
