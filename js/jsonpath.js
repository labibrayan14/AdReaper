/*******************************************************************************
    ...
    Copyright (C) 2025-present Labib Rayan
...
/**
 * Implement the parsing of AdReaper-flavored JSON path queries.
 * 
 * Reference to original JSON path syntax:
 * https://goessner.net/articles/JsonPath/index.html
 * 
 * AdReaper-flavored JSON path implementation differs as follow:
 * 
 ...
 *   -     Official: $..book[?(@.isbn)]
 *   - AdReaper-flavored: ..book[?(.isbn)]
 * 
 * - AdReaper-flavor syntax does not (yet) support:
 *   - Array slice operator
 * 
 * - Regarding filter expressions, AdReaper-flavored JSON path supports a limited
 *   set of expressions since unlike the official implementation, AdReaper can't use
 ...
 *   - ..*
 * 
 * AdReaper-flavored syntax supports assigning a value to a resolved JSON path by
